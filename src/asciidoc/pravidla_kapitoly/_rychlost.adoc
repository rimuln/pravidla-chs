...
. Startovní pořadí pro první vyřazovací kola finále musí být stanoveno na základě umístění v kvalifikaci po prohlášení výsledků kvalifikace jako oficiální, a to následujícím způsobem:
+
[cols="6*^"]
|===
...
.. Pokud oba závodníci dosáhnou stejného času nebo nemají platný čas z jiného důvodu než předčasný start potom se příslušný rozběh opakuje. Pokud i po tomto rozběhu závodníci nebyli rozřazeni, pak budou porovnáni podle pořadí z kvalifikace. Aby se předešlo pochybnostem rozběh se neopakuje jestliže oba soutěžící nemohou odstartovat.
