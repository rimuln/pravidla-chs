...
... bude použit „chytač“ k zajištění dodatečné bezpečnosti v nižších částech stěny
...
[#prubeh-souteze]
=== PRŮBĚH SOUTĚŽE
. Semifinálová a finálová kola v lezení na obtížnost se musí konat za dodržení <<#podminky-izolace,podmínek izolace>>. Soutěžící, kteří v těchto kolech startují se musí ohlásit v izolační zóně během kontroly docházky po oficiálním uzavření izolace. Soutěžící, kteří tak neučiní, nemohou v daném kole soutěžit.
...
. [[prl-obt,{counter:prl-obt}]]Stanovený <<#cas-lezeni,časový interval na lezení>> je 6 minut ve všech kolech.
. [[prl-obt-2,{counter:prl-obt}]]V momentě, kdy soutěžící vejde do soutěžní zóny u paty lezecké cesty, má <<#cas-priprava,časový interval na přípravu>> 40 vteřin. Nezačne-li soutěžící po vypršení těchto 40 vteřin lézt, musí být ke startu okamžitě vyzván. Jakákoliv další prodleva bude mít za následek disciplinární postih v souladu s částí <<#disciplinarni-rizeni>>. <<#cas-priprava,Časový interval na přípravu>> platí i v případě lezení kol, pro které neplatí <<#podminky-izolace,podmínky izolace>>.
. [[prl-obt-3,{counter:prl-obt}]]Každý pokus soutěžícího je považovaný za zahájený a čas (<<#cas-lezeni, časový interval na lezení>>) se začne měřit v momentě, kdy obě chodidla soutěžícího opustí zem. Aby se předešlo pochybnostem, traťový rozhodčí určí, zda pokus začal nebo se jedná o úpravu postavení před startem.
. [[prl-obt-4,{counter:prl-obt}]]Soutěžící se v průběhu svého pokusu na cestě může ptát, kolik z času mu zbývá, přičemž Hlavní rozhodčí musí soutěžícího okamžitě informovat nebo někoho pověřit, aby soutěžícího informoval.
. [[prl-obt-5,{counter:prl-obt}]]Soutěžící v průběhu pokusu na cestě:
.. nesmí čistit chyty
...
. [[prl-obt-6,{counter:prl-obt}]]Pokus je považovaný za ukončený a měření času musí být zastaveno:
.. [[prl-obt-6-1,{counter:prl-obt-6:a}]]pokud bylo lano :
... zapnuto z regulérní polohy do poslední expresky. 
... V případě cesty lezené top-rope (mládež), je nutné dosáhnout posledního chytu kontrolovaně oběma rukama. Tento chyt musí být jasně označen a musí na něj být upozorněno při předlezení.
.. [[prl-obt-6-2,{counter:prl-obt-6}]]spadnul
.. [[prl-obt-6-3,{counter:prl-obt-6}]]pokus byl ukončen Hlavním rozhodčím

. Hlavní rozhodčí musí ukončit pokus soutěžícího jestliže: 
.. má-li za to, že další postup na trati by byl nebezpečný
.. soutěžící
... překročil určený <<#cas-lezeni,časový interval na lezení>> pro danou cestu 
...
. Nákres cesty musí být připravený Hlavním stavěčem za konzultace s Hlavním rozhodčím před startem každého kola soutěže. Bodování chytů bude uvedené v nákresu cestu a po dobu konání kola je neměnné. Každý nákres cesty:
.. měl by být vyvěšený na oficiální nástěnce a elektronicky dostupný ve veřejném prostoru (např. mobilní aplikace) včetně bodování po skončení společné prohlídky a před zahájením daného kola.
.. měl by být vyvěšený bez bodování ve <<#svolavaci-zona,svolávací zóně>>
...
.. „TOP“ , pokud soutěžící dokončil cestu během časového limitu splněním  dle podmínek bodu <<#prubeh-lezeni>>.<<prl-obt-6>>.<<prl-obt-6-1>>
.. hodnota nejvyššího chytu, definovaná v nákresu cesty, který byl soutěžícím <<#kontrolovat,držený>> nebo <<#pouzit,použitý>> předtím než:
... spadnul, nebo
...
Pokud dosáhnou remízující závodníci ve finálovém kole po uplatnění zpětného hodnocení i shodného času, budou hodnoceni na stejném místě. Nekonají se již tedy žádná superfinále.
...
. Při závodech nejvyšších soutěží je počet soutěžících kvalifikujících se pro semifinále 20 a pro finále 8 soutěžících. V případě, že počet soutěžících, kteří se registrují na závod je menší než 20, pak se semifinálové kolo ruší a do finále postupuje 8 soutěžících.
. U ligových závodů všech úrovní se automaticky vynechává semifinále a do finále postupuje 8 soutěžících.
. Stanovená kvóta bude naplněna soutěžícími s nejlepším umístěním z předešlého kola poté, co byly výsledky prohlášené za oficiální a vypořádány všechny protesty.
