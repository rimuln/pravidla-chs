...
.. měl by být vyvěšený na oficiální nástěnce a elektronikcy dostupný ve veřejném prostoru (např. mobilní aplikace) včetně bodování po skončení společné prohlídky a před zahájením daného kola.
