...
. Veškeré oficiální výsledkové listiny se vydávají ve formátu stanoveném ČHS, na oficiální soutěžní tabuli. Výsledkovou listinu lze zveřejnit i elektronicky ve veřejně dostupném prostoru (např. mobilní aplikace). Kopie výsledkových listin je vhodné poskytnout oficiálním soutěžním činitelům, komentátorovi a zástupcům médií. 
