...
. Všichni soutěžící způsobilí soutěžit v některém kole soutěže se musejí zaprezentovat v registračním oddělení, a to v časovém limitu určeném pořadateli.
...
.. může přinést do <<#svolavaci-zony,svolávací zóny>>/<<#tranzitni-zony,tranzitní zóny>>, ale ne do soutěžní zóny
