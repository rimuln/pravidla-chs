...
.. Obtížnost: cesty se lezou s jištěním soutěžícího lanem a nejdelší dosažená vzdálenost v linii cesty určuje umístění soutěžícího.
.. Boulder: řada jednotlivých, krátkých cest (boulderů) je lezena bez lezeckého lana, s ochrannými matracemi. Úhrnný počet bodů dosažených soutěžícím při lezení boulderů a počet pokusů nutných k jejich získání určuje umístění soutěžícího.
.. Rychlost: cesty jsou lezeny s horním jištěním (top-rope). O umístění soutěžícího rozhoduje čas, potřebný k přelezení cesty.
.. Boulder&Obtížnost: soutěží se v disciplínách Boulder a Obtížnost. Výkony v jednotlivých disciplínách se převedou na body a jejich součet určí celkové pořadí.

. Soutěže se mohou sestávat z oddělených soutěží pro lezení na obtížnost, boulderu a lezení na rychlost. V jednotlivé soutěži nemusejí být všechny disciplíny zastoupeny.
...
. Hlavní rozhodčí po poradě s Hlavním stavěčem má pravomoc dělat rozhodnutí související s otázkami bezpečnosti v <<#soutezni-prostor,soutěžním prostoru>>, včetně toho, že odmítne povolit start nebo pokračování jakékoliv části soutěže. Jakákoliv osoba, na kterou má Hlavní rozhodčí podezření, že porušila nebo pravděpodobně porušila bezpečnostní postupy, bude zbavena svých práv a/nebo bude muset opustit závodiště.
. Jističi jmenovaní pořadatelem musí být vycvičeni pro soutěžní způsob jištění. Hlavní rozhodčí může pořadatelům kdykoliv v průběhu soutěže nařídit výměnu kteréhokoliv jističe. Je-li jistič vyměněn, nesmí mu být dovoleno nadále jistit jakéhokoliv soutěžícího v závodě ve kterém byl vyměněn.
...
[#standardy]
=== VYBAVENÍ
. Veškeré vybavení používané v soutěži – jak organizátorem, tak soutěžícími - musí být v souladu s odpovídajícími ČSN EN normami nebo srovnatelnými mezinárodními ekvivalenty pokud není ČHS uvedeno jinak. Ve výjimečných případech může být vybavení schváleno hlavním rozhodčím. Aplikované normy v tuto chvíli jsou:
+
[cols="2*",options="header",width="75%"]
[.center]
|===
|Vybavení|Aplikovaný standard
|Automatické jistící zařízení (rychlost)| EN 341:2011 Class A
...
. Hlavní rozhodčí musí ověřit, že je na místě vhodně kvalifikovaný zdravotnický personál, aby bylo možné zajistit rychlou pomoc v případě jakékoliv nehody nebo úrazu jakéhokoliv <<#clenove-tymu,člena týmu>>. Tento zdravotnický personál soutěže musí být přítomen od plánovaného otevření izolace nebo rozcvičovací zóny do konce pokusu posledního soutěžícího.
...
+
Startovní listiny budou zveřejněny na oficiální soutěžní vývěsní tabuli a v izolaci. Startovní listiny lze považovat za oficiální jejich zveřejněním v elektronické podobě na veřejně dostupné platformě (např. mobilní aplikace). Startovní listiny musí být k dispozici členům soutěžní poroty, vedoucím týmů, komentátorovi a zástupcům médií.
...
. Startovní listiny nesmí obsahovat jména sponzorů nebo partnerů soutěžících. Je povoleno uvádět pouze oddíl ČHS závodníka, členství v resortním centru (např. Victoria, Olymp apod.),  individuální členství v ČHS nebo nic. Startovní listiny mohou obsahovat jména či loga smluvních sponzorů nebo partnerů ČHS. 
. Způsob přípravy startovních listin pro jednotlivé disciplíny je uveden v odstavci <<#startovni-listiny-obtiznost>> pro obtížnost, odstavci <<#startovni-listiny-boulder>> pro boulder a odstavcích <<#kvalifikace-kf-rychlost>>, <<#kvalifikace-sf-rychlost>>, <<#finale-kf-sf-rychlost>> pro rychlost.

[#registrace]
=== REGISTRACE
. Všichni soutěžící účastnící se nejvyšších soutěží, závodů 1. a 2. ligy musí mít platnou <<#zavodni-registrace,závodní registraci>> dle https://www.horosvaz.cz/res/archive/423/070396.pdf?seek=1637244137[Směrnice o registraci závodníků]
. Všichni soutěžící účastnící se nejvyšších soutěží, závodů 1. a 2. ligy se musí do závodu registrovat předem. Dodatečná registrace na místě nebude možná.
. Všichni soutěžící způsobilí soutěžit v některém kole soutěže se musejí zaprezentovat v registračním oddělení, a to v časovém limitu určeném pořadatelem.

[#soutezni-prostor-p]
=== SOUTĚŽNÍ PROSTOR
. Soutěžní prostor musí být oddělen od jakéhokoliv veřejně dostupného prostoru
. Kouření v soutěžním prostoru je zakázáno.
. Žádný <<#clenove-tymu,člen týmu>> u sebe nesmí mít žádné elektronické komunikační zařízení, když se nalézá v soutěžním prostoru, aniž by mu to povolil Hlavní rozhodčí.
. Soutěžící nesmí v průběhu prohlídky a lezení poslouchat žádné audio zařízení.
...
. [[pdsp-2,{counter:pdsp}]]Do soutěžního prostoru nesmějí jiná zvířata než <<#asistencni-pes,asistenční pes>>. Výjimky z tohoto pravidla musí být schváleny Hlavním rozhodčím.
...
. Závodník
.. musí mít:
... oblečení na horní i dolní části těla. V případě nevhodných klimatických podmínek může hlavní rozhodčí udělit výjimku z tohoto pravidla.
... během pokusu lezeckou obuv a v disciplínách, kde to je relevantní úvazek

.. může použít:
... pytlík na magnézium a suché nebo tekuté magnézium pouze na své ruce. Nesmí být použité další činidla pro zvýšení přilnavosti (např. pryskyřice)
... elastické kompresní bandáže/zábaly (na horní nebo dolní končetiny)
... kineziologické a podobné pásky pokud je to nutné k prevenci nebo léčbě úrazu
... helmu

.. nesmí během pokusu mít oblečené ani nést:
... audio zařízení jakéhokoliv popisu
... <<#rukavice,rukavice>> nebo <<#chranic-kolen,chrániče kolen>>
+
jiné než je speciálně povolené těmito pravidly.

.. může přinést do <<#svolavaci-zona,svolávací zóny>>/<<#tranzitni-zona,tranzitní zóny>>, ale ne do soutěžní zóny
... tašky/batohy nebo jiná zavazadla
... bateriově napájené ventilátory nebo jiné zařízení
+
...
.. Technický incident v případě, že soutěžící získal nespravedlivé zvýhodnění
+
Získal-li soutěžící nespravedlivé zvýhodnění, pak Hlavní rozhodčí může ukončit pokus, nebo povolit soutěžicímu pokračovat. v tomto případě výsledek pokusu bude zpětně vyhodnocen. V tomto případě nesmí být povolen žádný další pokus v cestě dokud není Technický incident následně potvrzen.
...
. Pro posuzování se smí používat pouze oficiální záznam a oficiální vysílání ČHS, pokud je k dispozici. Záznam si smí prohlížet pouze Hlavní rozhodčí, pomocní rozhodčí, Hlavní stavěč a Delegát ČHS.
...
. Na konci soutěže je třeba připravit a vydat oficiální výsledkovou listinu, ukazující konečné umístění soutěžících, stejně tak jako jejich výsledky z dílčích kol soutěže. Listinu musí podepsat Hlavní rozhodčí. Oficiální výsledkové listiny musí obsahovat čas vydání.

. Veškeré oficiální výsledkové listiny se vydávají ve formátu stanoveném ČHS, na oficiální soutěžní tabuli. Výskladovou listinu lze zveřejnit i elektronicky ve veřejně dostupném prostoru (např. mobilní aplikace). Kopie výsledkových listin je vhodné poskytnout oficiálním soutěžním činitelům, komentátorovi a zástupcům médií. 

[#hodnoceni-a-zebricky]
=== HODNOCENÍ A ŽEBŘÍČKY

. Postupy pro individuální hodnocení soutěžících v průběhu soutěže jsou popsány v příslušných částech věnujících se lezení na obtížnost, boulderu a rychlosti.

. ČHS vydává následující společné žebříčky hodnocení:
.. Hodnocení závodů
... Český pohár, včetně Českého poháru mládeže a Českého poháru do 15 let
... 2. liga
.. Průběžný ranking seriálů
.. Žebříček závodníků ČHS
... Společný žebříček závodníků pro soutěže Český pohár, 2. liga, 3. liga ve věkových kategoriích

+
Podrobný popis způsobu sestavení žebříčku Českého poháru, průběžného rankingu a žebříčku závodníků ČHS je možné najít na webových stránkách ČHS a v prováděcích předpisech pro daný rok.
