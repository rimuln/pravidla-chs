...
... začátek a konec každého <<#cas-lezení, časového intervalu na lezení>>
... minutu do konce <<#cas-lezení, časového intervalu na lezení>>
...
... byl kontrolovaný chyt (libovolnou rukou) označený jako zóna, nebo
... byl úspěšně dokončený boulder bez kontrolovaného chytu, který byl označený jako zóna
