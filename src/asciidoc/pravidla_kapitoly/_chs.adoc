...
.. zajištění, aby se všichni členové reprezentující oddíl chovali ke všem ostatním členům týmu, funkcionářům a ostatním, kteří se podílejí na provozování tohoto sportu s plným a náležitým respektem po celou dobu, jak v průběhu soutěže, tak v průběhu jakékoli nesoutěžní činnosti.
