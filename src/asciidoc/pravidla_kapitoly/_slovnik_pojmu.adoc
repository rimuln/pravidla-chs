...
[[clenove-tymu]]Členové týmu:: společně tvoří soutžění tým tým. Oficiální doprovod týmu jsou členové týmů. Soutěžním týmem by měl být oddíl registrovaný v ČHS.
...
Přípravná zóna: je prostor určený hlavním rozhodčím mezi Izolační zónou nebo Tranzitní zónou a Soutěžním prostorem sloužicí k pobytu soutěžících tesně před vstupem do Soutěžního prostoru.
