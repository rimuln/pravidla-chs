...
:toc: left
:toclevels: 2
= Výjimky ze soutěžních pravidel ČHS pro Nejvyšší soutěže, 1. ligu mládeže, 1. ligu dětí do 15 let ve sportovním lezení pro rok 2025
...
== Obecně
Pro Mistrovství republiky a závody 1. ligy v kategoriích do 15 let platí <<provadeci_predpisy_mladez_1_liga.adoc#,„Prováděcí předpisy ČHS pro závody nejvyšších soutěží a 1. ligy mládeže ve sportovním lezení pro rok 2023“>> a <<pravidla_sl.adoc#,„Pravidla sportovního lezení ČHS 2023“>> s výjimkami v těchto bodech:

== Lezecká stěna

. V případě, že stěna nesplňuje výškové požadavky dle soutěžních pravidel, ale umožňuje postavit plnohodnotné cesty v uvedené délce, může Organizátor udělit výjimku.

== Obtížnost
=== Povolené formáty

U závodů nejvyšší kategorie a 1. ligy v kategoriích do 15 let, lze kromě ustanovení pravidel sportovního lezení využít i tyto možnosti:
...
. Na prohlídku cesty, pokud se leze za dodržení <<pravidla_sl.adoc#podminky-izolace,podmínek izolace>>, mohou závodníky doprovázet trenéři pouze u kategorie U10. Tito trenéři v takovém případě musí zachovávat pravidla izolace.

[#bezpecnost-a-jisteni]
=== Bezpečnost a jištění
. Kvalifikační cesty:
+
Neplatí pro ně <<pravidla_sl.adoc#podminky-izolace,podmínky izolace>>

Kategorie U11 a U13:: musí lézt s horním jištěním (top-rope)
Kategorie U15:: může lézt s horním jištěním nebo se spodním jištěním.
...
Kategorie U11 a U13:: musí lézt s horním jištěním (top-rope)
Kategorie U15:: musí lézt se spodním jištěním 
...
=== Prohlídka boulderů
. Na prohlídku boulderů, pokud se leze <<pravidla_sl.adoc#boulder-format-sp,světovým formátem>>, mohou závodníky doprovázet trenéři pouze u kategorie U11. Tito trenéři v takovém případě musí zachovávat pravidla izolace.

=== Průběh závodu
. Kvalifikace se leze bez dodržení <<pravidla_sl.adoc#podminky-izolace,podmínek izolace>>

. Pro závody mládeže v kategoriích do 15 let neplatí ustanovení <<pravidla_sl.adoc#pl-kv-flash-boulder-5,5.4.5>> a <<pravidla_sl.adoc#pl-kv-flash-boulder-7,5.4.7>> <<pravidla_sl.adoc#,Pravidel sportovního lezení 2025>>, která zde mají pouze doporučující charakter.
