...
:toc: left
:toclevels: 2
= Výjimky ze soutěžních pravidel ČHS pro Nejvyšší soutěže, 1. ligu mládeže, 1. ligu dětí do 15 let ve sportovním lezení pro rok 2026
...
. Pro závody mládeže v kategoriích do 15 let neplatí ustanovení <<pravidla_sl.adoc#pl-kv-flash-boulder-5,5.4.5>> a <<pravidla_sl.adoc#pl-kv-flash-boulder-7,5.4.7>> <<pravidla_sl.adoc#,Pravidel sportovního lezení 2026>>, která zde mají pouze doporučující charakter.
