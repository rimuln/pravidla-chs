...
:toc: left
:toclevels: 2
= Výjimky ze soutěžních pravidel ČHS pro Nejvyšší soutěže a 1. ligu mládeže do 14 let ve sportovním lezení pro rok 2025
...
Kategorie U14:: může lézt s horním jištěním nebo se spodním jištěním.
